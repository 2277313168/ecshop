...
<h1>
<span class="action-span"><a href="/shop/ecshop/index.php/Admin/Category/catAdd">添加分类</a></span>
	...
	<div class="list-div" id="listDiv">
		<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
			<tbody>
                ...
                <?php if(is_array($catList)): $i = 0; $__LIST__ = $catList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" class="0" id="0_1">
					...
					<td width="10%">
                        <img  <?php if($vo["is_show"] == 1): ?>src="<?php echo (ADMIN_PUBLIC); ?>/images/yes.gif"   <?php else: ?> src="<?php echo (ADMIN_PUBLIC); ?>/images/no.gif"<?php endif; ?>      onclick="listTable.toggle(this, 'toggle_is_show', 1)"  >
                    </td>
					...
					<td width="24%" align="center">
						...
						<a href="/shop/ecshop/index.php/Admin/Category/catEdit/id/<?php echo ($vo["cat_id"]); ?>">编辑</a> |
						<a href="/shop/ecshop/index.php/Admin/Category/catDelete/id/<?php echo ($vo["cat_id"]); ?>" onclick="listTable.remove(1, '您确认要删除这条记录吗?')" title="移除">移除</a>
					</td>
