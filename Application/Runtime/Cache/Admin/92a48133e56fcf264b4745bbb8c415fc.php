        ...
        <table width="90%" id="detail-table" style="display: none;">
          <tbody><tr>
            <td>
                ...
                <!--<script type="text/javascript" charset="utf-8" src="/shop/ecshop/Public/ueditor/ueditor.config.js"></script>-->
                <!--<script type="text/javascript" charset="utf-8" src="/shop/ecshop/Public/ueditor/ueditor.all.min.js"> </script>-->
                <!--<script type="text/javascript" charset="utf-8" src="/shop/ecshop/Public/ueditor/lang/zh-cn/zh-cn.js"></script>-->
                <!--<script id="editor" type="text/plain"  name="content" style="width:300px;height:200px;"></script>-->
