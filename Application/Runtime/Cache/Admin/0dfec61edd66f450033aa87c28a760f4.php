...
<form method="post" action="" name='theForm'>
  ...
  <tr>
    ...
    <td style="padding-left: 50px">
      ...
      <tr>
      <td colspan="2" align="right"><img src="/shop/index.php/Admin/Login/verifyCode/<?php echo ($random); ?>" width="145" height="30" alt="CAPTCHA" border="1" onclick= this.src="/shop/index.php/Admin/Login/verifyCode/"+Math.random() style="cursor: pointer;" title="看不清？点击更换另一个验证码。" />
      </td>
      </tr>
