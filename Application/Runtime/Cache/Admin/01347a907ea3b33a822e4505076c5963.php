...
<h1>
<span class="action-span"><a href="/shop/index.php/Admin/Category/catIndex">商品分类</a></span>
...
<div class="main-div">
  <form action="/shop/index.php/Admin/Category/catAdd" method="post" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
	 <table width="100%" id="general-table">
		<tbody>
			...
			<tr>
				...
				<td><input type="text" name="sort_order" value="" size="15"></td>
			</tr>
