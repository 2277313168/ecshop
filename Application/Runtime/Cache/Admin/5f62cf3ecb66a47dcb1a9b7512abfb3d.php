...
<head>
    ...
    <script type="text/javascript" src="<?php echo (ADMIN_PUBLIC); ?>/js/global.js"></script>
    <script type="text/javascript" src="<?php echo (ADMIN_PUBLIC); ?>/js/utils.js"></script>
    <script type="text/javascript" src="<?php echo (ADMIN_PUBLIC); ?>/js/transport.js"></script>
    <style type="text/css">
        body {
            background: #80BDCB;
        }
        ...
        .explode {
            background: url(<?php echo (ADMIN_PUBLIC); ?>/images/menu_minus.gif) no-repeat 0px 3px;
            font-weight: bold;
        }

        .collapse {
            background: url(<?php echo (ADMIN_PUBLIC); ?>/images/menu_plus.gif) no-repeat 0px 3px;
            font-weight: bold;
        }

        .menu-item {
            background: url(<?php echo (ADMIN_PUBLIC); ?>/images/menu_arrow.gif) no-repeat 0px 3px;
            font-weight: normal;
        }
...
<div id="tabbar-div">
    <p>
			<span style="float:right; padding: 3px 5px;">
				<a href="javascript:toggleCollapse();"><img id="toggleImg"
                                                            src="<?php echo (ADMIN_PUBLIC); ?>/images/menu_minus.gif"
                                                            width="9" height="9" border="0" alt="闭合"></a>
			</span>
...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            ...
            <?php if(is_array($authMenu)): $i = 0; $__LIST__ = $authMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="explode" key="02_cat_and_goods" name="menu"> <?php echo ($vo["auth_name"]); ?>管理
                    <?php if(is_array($vo["child"])): $i = 0; $__LIST__ = $vo["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><!--<?php  var_dump("/shop/ecshop/index.php/Admin".'/'.$vo1['controller_name'].'/'.$vo1['action_name']) ?>-->
                      <li class="menu-item"><a href="<?php echo U($vo1['controller_name'].'/'.$vo1['action_name']) ?>"  target="main-frame"><?php echo ($vo1["auth_name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <!--<li class="explode" key="05_order" name="menu"> 权限管理-->
                <!--<ul style="display: block;">-->
                    <!--<li class="menu-item"><a href="/shop/ecshop/index.php/Admin/Auth/authIndex" target="main-frame">权限列表</a></li>-->
                    <!--<li class="menu-item"><a href="/shop/ecshop/index.php/Admin/Role/roleIndex" target="main-frame">角色列表</a></li>-->
                    <!--<li class="menu-item"><a href="/shop/ecshop/index.php/Admin/Admin/adminIndex" target="main-frame">管理员列表</a></li>-->
                <!--</ul>-->
            <!--</li>-->
...
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? '<?php echo (ADMIN_PUBLIC); ?>/images/menu_minus.gif' : '<?php echo (ADMIN_PUBLIC); ?>/images/menu_plus.gif';
