...
<div class="main-div">
  <form action="/shop/ecshop/index.php/Admin/Auth/authAdd" method="post" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
	 <table width="100%" id="general-table">
		<tbody>
			<tr>
				<td class="label">权限名称:</td>
				<td><input type="text" name="auth_name" maxlength="20" value="" size="27"> <font color="red">*</font></td>
			</tr>
			<tr>
				...
				<td>
					<select name="auth_pid">
						...
						<?php if(is_array($authList)): $i = 0; $__LIST__ = $authList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["auth_id"]); ?>">
			...
			<tr >
				...
				<td><input type="text" name="module_name" value="" size="12"></td>
			</tr>
			<tr >
				<td class="label">控制器名称:</td>
				<td><input type="text" name="controller_name" value="" size="12"></td>
			</tr>

			<tr >
				<td class="label">方法名称:</td>
				<td><input type="text" name="action_name" value="" size="12"></td>
			</tr>
