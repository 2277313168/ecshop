    ...
    <form method="post" action="/shop/ecshop/index.php/Admin/Brand/brandEdit" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
        ...
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td><input type="text" name="url" maxlength="60" size="40" value="<?php echo ($brand["url"]); ?>"></td>
            </tr>
            <tr>
                <td class="label"><a href="javascript:showNotice('warn_brandlogo');" title="点击此处查看提示信息">

                    <img src="/shop/ecshop/<?php echo ($brand["logo"]); ?>" width="50" height="50" border="0" alt="点击此处查看提示信息"></a>品牌LOGO</td>
        ...
        请上传图片，做为品牌的LOGO！        </span>
            ...
            <tr>
                ...
                <?php if($brand["is_show"] == 1): ?>checked="checked"<?php endif; ?>
                > 是
                    <input type="radio" name="is_show" value="0"
                    <?php if($brand["is_show"] == 0): ?>checked="checked"<?php endif; ?>
