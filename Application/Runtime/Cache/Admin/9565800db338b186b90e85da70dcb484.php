  ...
  <table cellpadding="3" cellspacing="1">
    <tbody>
        ...
        <?php if(is_array($brandList)): $i = 0; $__LIST__ = $brandList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td class="first-cell"><span style="float:right"><a href=<?php echo ($vo["brand_logo"]); ?> target="_brank"><img src="<?php echo ($vo["logo"]); ?>" width="16" height="16" border="0" alt="品牌LOGO"></a></span>
