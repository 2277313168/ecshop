...
<head>
    ...
    <link rel="stylesheet" href="<?php echo (HOME_PUBLIC); ?>/style/goods.css" type="text/css">
    ...
    <script type="text/javascript" src="<?php echo (HOME_PUBLIC); ?>/js/goods.js"></script>
...
<div class="main w1210 mt10 bc">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<a href="/shop/ecshop/index.php/Home/Index/index">首页</a> > <a href="">电脑、办公</a> > <a href="">笔记本</a> >
            <?php echo ($goods["goods_name"]); ?></h2>
    </div>
    <!-- 面包屑导航 end -->
    ...
    <div class="goods_left fl">
        ...
        <div class="related_view newgoods leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo (HOME_PUBLIC); ?>/images/relate_view1.jpg" alt=""/></a>
                            </dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo (HOME_PUBLIC); ?>/images/relate_view2.jpg" alt=""/></a>
                            </dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo (HOME_PUBLIC); ?>/images/relate_view3.jpg" alt=""/></a>
                            </dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo (HOME_PUBLIC); ?>/images/relate_view4.jpg" alt=""/></a>
                            </dt>
                    ...
                    <li class="last">
                        <dl>
                            <dt><a href=""><img src="<?php echo (HOME_PUBLIC); ?>/images/relate_view5.jpg" alt=""/></a>
                            </dt>
        ...
        <div class="viewd leftbar mt10">
            ...
            <div class="leftbar_wrap">
                ...
                <dl class="last">
                    <dt><a href=""><img src="<?php echo (HOME_PUBLIC); ?>/images/crazy4.jpg" alt=""/></a></dt>
    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <!--<?php echo "/shop/ecshop"."/".$goods['goods_img']; ?>-->
            <!-- 图片预览区域 start -->
            <div class="preview fl">
                <div class="midpic">
                    <a href='<?php echo "/shop/ecshop"."/".$goods["goods_img"]; ?>' class="jqzoom" rel="gal1">
                        <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="/shop/ecshop/<?php echo ($goods["goods_img"]); ?>" width="350px" height="350px"/>
                        <!-- 第一幅图片的中图 -->
                    </a>
                </div>

                <!--使用说明：此处的预览图效果有三种类型的图片，大图，中图，和小图，取得图片之后，分配到模板的时候，把第一幅图片分配到 上面的midpic 中，
                其中大图分配到 a 标签的href属性，中图分配到 img 的src上。 下面的smallpic 则表示小图区域，格式固定，在 a 标签的 rel属性中，
                分别指定了中图（smallimage）和大图（largeimage），img标签则显示小图，按此格式循环生成即可，但在第一个li上，要加上cur类，
                        ...
                        <ul>
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);"
                                   rel="{gallery: 'gal1', smallimage:'<?php echo " /shop/ecshop"."/".$goods["goods_img"]; ?>' ,largeimage:'<?php echo "/shop/ecshop"."/".$goods["goods_img"]; ?>' }"><img
                                    src="/shop/ecshop/<?php echo ($goods["goods_img"]); ?>"/> </a>
                            </li>
                            <?php foreach ($goodsAlbum as $k => $v): ?>
                            <li>
                                <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo " /shop/ecshop"."/".$v["img"]; ?>' ,largeimage: '<?php echo "/shop/ecshop"."/".$v["img"]; ?>' }"><img
                                    src="/shop/ecshop/<?php echo ($v["img"]); ?>"/> </a>
                            </li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    <input id="inputGoodsId" type="hidden" value="<?php echo ($goods["goods_id"]); ?>"/>
                    <li><span>商品编号： </span><?php echo ($goods["goods_id"]); ?></li>
                    <li class="market_price"><span>定价：</span><em>￥<?php echo ($goods["market_price"]); ?>元</em></li>
                    <li class="shop_price"><span>本店价：</span> <strong id="shopPrice"></strong> <a href="">(降价通知)</a></li>
                    <li><span>上架时间：</span><?php echo date('Y-m-d H:i:s', $goods['add_time']); ?></li>
                            ...
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <input type="radio" name="color"
                                           value="<?php echo ($v1["attr_value"]); ?>" <?php if($k1==0) echo 'checked="checked"'; ?> />
                                    </a>
                                    <?php endforeach; ?>
                                </dd>
                            </dl>
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    ...
                    <div class="desc mt10">
                        ...
                        <img src="<?php echo (HOME_PUBLIC); ?>/images/desc1.jpg" alt=""/>
                        <p style="height:10px;"></p>
                        <img src="<?php echo (HOME_PUBLIC); ?>/images/desc2.jpg" alt=""/>
                        <p style="height:10px;"></p>
                        <img src="<?php echo (HOME_PUBLIC); ?>/images/desc3.jpg" alt=""/>
                        <p style="height:10px;"></p>
                        <img src="<?php echo (HOME_PUBLIC); ?>/images/desc4.jpg" alt=""/>
                        <p style="height:10px;"></p>
                        <img src="<?php echo (HOME_PUBLIC); ?>/images/desc5.jpg" alt=""/>
                        <p style="height:10px;"></p>
                        <img src="<?php echo (HOME_PUBLIC); ?>/images/desc6.jpg" alt=""/>
                        <p style="height:10px;"></p>
                        <img src="<?php echo (HOME_PUBLIC); ?>/images/desc7.jpg" alt=""/>
                        <p style="height:10px;"></p>
                        <img src="<?php echo (HOME_PUBLIC); ?>/images/desc8.jpg" alt=""/>
                        <p style="height:10px;"></p>
                        <img src="<?php echo (HOME_PUBLIC); ?>/images/desc9.jpg" alt=""/>
                    </div>
                </div>
                <!-- 商品介绍 end -->
                ...
                <div class="comment detail_div mt10">
                    ...
                    <div id="comment_page" class="page mt20">
                        <a id="load_more" onclick="ajaxGetCommentByPageNum();" href="javascript:void(0);">加载更多评论</a>
...
<script>
    ...
    $.ajax({
        type: "GET",
        url: '/shop/ecshop/index.php/Home/Index/ajaxComment',
        dataType: 'json',
        success: function (data) {
            if (data == 1) {
                var htmlForm = '';
                htmlForm += '<form id="comment_real_form">';
                htmlForm += '<input type="hidden" name="goods_id" value="<?php echo ($goods['
                goods_id
                ']); ?>" />';
                htmlForm += '<ul><li>';
                htmlForm += '<label for=""> 评分：</label>';
                htmlForm += '<input type="radio" name="star" value="5" /><strong class="star star5"></strong>';
                htmlForm += '<input type="radio" name="star" value="4" /> <strong class="star star4"></strong>';
                htmlForm += '<input type="radio" name="star" value="3" checked="checked" /> <strong class="star star3"></strong>';
                htmlForm += '<input type="radio" name="star" value="2" /> <strong class="star star2"></strong>';
                htmlForm += '<input type="radio" name="star" value="1" /> <strong class="star star1"></strong>';
                htmlForm += '</li><li>';
                htmlForm += '<label for="">评价内容：</label>';
                htmlForm += '<textarea name="content" id="" cols="" rows=""></textarea>';
                htmlForm += '</li><li><label for="">印象：</label><input name="yx" /> 多个印象用，隔开</li><li>';
                htmlForm += '  <label for="">&nbsp;</label><input type="button" value="提交评论" class="comment_btn"/></li></ul></form>';


                // htmlForm = $(htmlForm);
                $("#comment_form").html(htmlForm);

                //$("#comment_form").html('<form id="comment_real_form"><input type="hidden" name="goods_id" value="<?php echo ($goods['goods_id']); ?>" /><ul><li><label for=""> 评分：</label><input type="radio" name="star" value="5" /> <strong class="star star5"></strong><input type="radio" name="star" value="4" /> <strong class="star star4"></strong><input type="radio" name="star" value="3" checked="checked"/> <strong class="star star3"></strong><input type="radio" name="star" value="2" /> <strong class="star star2"></strong><input type="radio" name="star" value="1" /> <strong class="star star1"></strong></li><li><label for="">评价内容：</label><textarea name="content" id="" cols="" rows=""></textarea></li><li><label for="">印象：</label><input name="yx" /> 多个印象用，隔开</li><li><label for="">&nbsp;</label><input type="button" value="提交评论" class="comment_btn"/></li></ul></form>');
                ...
                $('.comment_btn').click(function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '/shop/ecshop/index.php/Home/Comment/ajaxAddComment',
                        ...
                        success: function (data) {
                            if (data.ok == 1) {
                                ...
                                var newComment = '';
                                newComment += '<div style="display:none;" class="comment_items mt10"><div class="user_pic"><dl>';
                                newComment += '<dt><a href=""><img src="/shop/ecshop' + data.user_img + '" alt="" /></a></dt>';
                                newComment += '<dd><a href="">' + data.user_name + '</a></dd></dl></div>';
                                newComment += '<div class="item"><div class="title">';
                                newComment += '<span>' + data.pubtime + '</span>';
                                newComment += '<strong class="star star' + data.star + '"></strong>';
                                newComment += '</div><div class="comment_content">' + data.content + '</div>';
                                newComment += '<div class="btns"><a href="" class="reply">回复(0)</a><a href="" class="useful">有用(0)</a>';
                                newComment += '</div></div><div class="cornor"></div></div>';


                                //字符串对象化
                                newComment = $(newComment);

                                $('.comment_summary').after(newComment);
                                //清空表单
                                document.getElementById('comment_real_form').reset();
                                //animate() 方法执行 CSS 属性集的自定义动画
                                //$(selector).animate(styles,speed,easing,callback)
                                // 先滚动到710这个位置然后再显示出评论的内容
                                $('body').animate({scrollTop: "710px"}, 500, 'linear', function () {
    ...
    $('#login_a').click(function () {
        $.ajax({
            type: 'GET',
            url: "/shop/ecshop/index.php/Home/Index/ajaxLogin",
            dataType: 'json',
            success: function (data) {
                location.href = "/shop/ecshop/index.php/Home/Register/login";
            }
        });
    ...
    function ajaxGetCommentByPageNum() {
        $.ajax({
            type: 'GET',
            url: "/shop/ecshop/index.php/Home/Comment/ajaxGetComment/id/" + goodsId + "/page/" + currentPage,
            dataType: 'json',
            success: function (data) {
                ...
                $(data).each(function (k, v) {
                    var newComment = '';
                    newComment += '<div style="display:none" class="comment_items mt10"><div class="user_pic"><dl>';
                    newComment += '<dt><a href=""><img src="/shop/ecshop' + v.user_img + '" alt="" /></a></dt>';
                    newComment += '<dd><a href="">' + v.user_name + '</a></dd></dl></div>';
                    newComment += '<div class="item"><div class="title">';
                    newComment += '<span>' + v.pubtime + '</span>';
                    newComment += '<strong class="star star' + v.star + '"></strong>';
                    newComment += '</div><div class="comment_content">' + v.content + '</div>';
                    newComment += '<div class="btns"><a href="" class="reply">回复(0)</a><a href="" class="useful">有用(0)</a>';
                    newComment += '</div></div><div class="cornor"></div></div>';

                    newComment = $(newComment);
                    $('#comment_page').before(newComment);
                    newComment.fadeIn(500);//放在后面，与style="display:none"配合使用
                })
                currentPage++; // 下一次取下一页
                ...
                //如果没有评论的数据
                if(data == null){
                    $(window).unbind('scroll'); //把滚动条的scroll事件拿掉
                    $('#load_more').remove();
                }
    ...
    //触发加载评论函数,为滚动条绑定一个滚动事件
    $(window).scroll(function () {
        if(pending == 1){
            return;
        }
        var pos = $('#load_more').offset().top;
    ...
    $.ajax({
        type: "GET",
        url: "/shop/ecshop/index.php/Home/Index/ajaxShopPrice/id/" + goodsId,
        success: function (data) {
            // 把会员价格放到页面中
            $("#shopPrice").html('￥ ' + data + ' 元');
        }
    });
